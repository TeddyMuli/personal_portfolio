...
const Resume = () => {
	return (
		<motion.div
			...
			className="min-h-[80vh] flex items-center justify-center py-12 xl:py-0 mb-12"
		>
						...
						<TabsContent value="experience" className="w-full">
							...
							<TabsContent value="about" className="w-full text-center xl:text-left">
								<div className="flex flex-col gap-[30px]">
									...
									<p
										className="max-w-[1200px] text-white/60 mx-auto xl:mx-0"
									>{about.description}
									</p>
									<ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-6 max-w-[1200px] mx-auto xl:mx-0">
										{about.info.map((item, index) => {
											return (
												<li key={index} className="flex items-left justify-start xl:justify-start gap-4">
